...
All three methods seem to give comparable results in terms of predicting the outcome of the next game. It seems the model with a single home-court advantage parameter does slightly better.
