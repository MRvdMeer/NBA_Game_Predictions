...
In this part we will focus on modeling the difference in score between the two teams for a single game. We'll start with a simple model and gradually try to improve it.
